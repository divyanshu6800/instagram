    <main class="main-container">
      <section class="content-container">
        <div class="content">
          <div class="stories">
            ...
            <div class="stories__content">
              ...
              <?foreach($stories as $story){
                $personWeFollow = $this->db->get_where('tbl_users', array('id' => $story->user_id))->result();
                ?>
              <button class="story story--has-story" data-toggle="modal" data-target="#user<?=$story->id?>">
                <div class="story__avatar">
                  <div class="story__border">
                    <svg
                      width="64"
                  ...
                  <div class="story__picture">
                    <?if(empty($personWeFollow[0]->image)){?>
                    <img src="<?=base_url()?>assets/frontend/default-user.png" alt="User Picture" />
                    <?}else{?>
                      <img src="<?=base_url().$personWeFollow[0]->image?>" alt="User Picture" />
                      <?}?>
                  </div>
                </div>
                <span class="story__user"><?=$personWeFollow[0]->username?></span>
              </button>
              <!-- =============== FRIEND STORY MODAL ======================= -->
              <div class="modal fade" id="user<?=$story->id?>" tabindex="-1" role="dialog" aria-labelledby="addStory<?=$story->id?>" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="addStory<?=$story->id?>"><?=$personWeFollow[0]->username?></h5><br />
                      <p style="font-size: 11px; margin-top: 30px; margin-left: -91px;"><?=$personWeFollow[0]->name?></p>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body text-center">
                        <img src="<?=base_url().$story->image?>" />
                    </div>
          ...
          <div class="posts refreshit">
            <!-- ============================================== -->
            <?foreach($main_feed as $posts){
        ...
        <section class="side-menu">
          <div class="side-menu__user-profile">
            ...
            <a href="<?=base_url()?>User/profile"><button class="side-menu__user-button">View</button></a>
          </div>
            ...
            <div class="side-menu__suggestions-content">
              ...
              <div class="side-menu__suggestion">
                <a href="#" class="side-menu__suggestion-avatar">
                  <?if(empty($sugestions->image)){?>
                  <img src="<?=base_url()?>assets/frontend/default-user.png" alt="User Picture" />
                  <?}else{?>
                    <img src="<?=base_url().$sugestions->image?>" alt="User Picture" />
                    <?}?>                </a>
